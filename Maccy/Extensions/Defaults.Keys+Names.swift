...
extension Defaults.Keys {
  ...
  static let historyRetentionDays = Key<Int>("historyRetentionDays", default: 7)
  ...
  static let windowSize = Key<NSSize>("windowSize", default: NSSize(width: 760, height: 720), suite: preferencesSuite)
